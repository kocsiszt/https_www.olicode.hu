...
document.getElementById('element-two').onmousemove = function(){
    isHover = true;
    hovered();
}
...
document.getElementById('element-three').ondblclick = function(){
    ...
    document.getElementById('3as').textContent = randomNumber;
}
...
document.getElementById('box7-input').onkeypress = function(hit){
    //console.log(hit);
    document.getElementById('element-seven').firstElementChild.innerHTML = hit.key;
